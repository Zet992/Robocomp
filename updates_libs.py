...
def perebor(graph, start, end):
    ...
    while n <= len(graph) or len(answer_paths) == 0:
        ...
        for path in all_paths:
            ...
            current_vertex = path.last_point()  # Берём последнюю точку
            ...
            for vertex in neighbours:
                ...
                current_path.add_points(vertex[0], vertex[1], graph)  # Добавляем в него текущую вершину
                temp_all_paths.append(current_path)  # И сохраняем его в общем списке с путями
